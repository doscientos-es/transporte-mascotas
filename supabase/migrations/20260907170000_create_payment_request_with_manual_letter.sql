-- A manual letter and its payable request must either be created together or not at all.
drop function if exists public.create_manual_carriage_letter(uuid, text, jsonb, jsonb, text, text, text, text, text[], public.payer_type, jsonb, boolean, jsonb, jsonb, integer);
...
begin
  ...
  insert into public.invoice_drafts (
    ...
    'solicitud_pago', 'whatsapp', '', v_billing_client ->> 'phone', auth.uid()
  );
...
revoke all on function public.create_manual_carriage_letter(uuid, text, jsonb, jsonb, text, text, text, text, text[], public.payer_type, jsonb, numeric, boolean, jsonb, jsonb, integer) from public, anon;
grant execute on function public.create_manual_carriage_letter(uuid, text, jsonb, jsonb, text, text, text, text, text[], public.payer_type, jsonb, numeric, boolean, jsonb, jsonb, integer) to authenticated;
