...
// Sections that belong exclusively to the client portal. Every other
// section belongs to the admin/transportista dashboard. Kept here so the
// two bundles and the layout share a single source of truth.
export const clientSections = new Set<NavSection>(['proximas-rutas', 'mis-transportes'])
...
export function dashboardLocationForPath(pathname: string, fallback: NavSection = 'cartas'): DashboardLocation {
