    ...
    >
      ...
      <div className="direction-field">
        ...
        <div className="route-direction-options">
          ...
          <button
            type="button"
            aria-pressed={direction === 'inversa'}
...
/* Legacy invoice dialog implementations were removed; delivery is manual-only. */
  ...
  return (
    ...
    >
      <div className="payer-options">
        ...
        <button
          type="button"
          aria-pressed={payer === 'destinatario'}
      ...
      <Button className="dialog-submit" disabled={generating} onClick={() => void generate()}>
