...
import type { AnimalSize, DailyRoute, Letter, RouteTemplate, ServiceAction } from '../lib/types'
import { boxGridSpan, boxSize, type VanAssignment, vanLanes } from '../lib/van'
...
export function VanPage({
  ...
  return (
    <>
      ...
      <p className="van-selection" role="status" aria-live="polite">
        {selectedBox === null
