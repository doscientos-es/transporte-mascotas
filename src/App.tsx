...
function LettersPage({ letters: searchedLetters, search, onSearchChange, onImport, onInvoice }: { letters: Letter[]; search: string; onSearchChange: (value: string) => void; onImport: () => void; onInvoice: (letter: Letter) => void }) {
  const pageSize = 8
